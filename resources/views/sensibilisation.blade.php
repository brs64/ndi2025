...
@section('title', 'Sensibilisation NIRD')
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-4xl font-bold text-gray-900 mb-6">Sobriété numérique</h2>
                <p class="text-lg text-gray-600 mb-6">
                    La sobriété numérique consiste à adopter une utilisation plus raisonnée et responsable des technologies numériques pour réduire leur impact environnemental et social.
                </p>
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900 mb-1">Limiter le stockage inutile</h3>
                            <p class="text-gray-600 text-sm">Suppression régulière des données obsolètes et optimisation de l'espace de stockage.</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <div class="flex-shrink-0 w-6 h-6 bg-nird-green rounded-full flex items-center justify-center mt-1 mr-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900 mb-1">Optimiser les usages</h3>
                            <p class="text-gray-600 text-sm">Privilégier les outils légers et désactiver les fonctionnalités non essentielles.</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <div class="flex-shrink-0 w-6 h-6 bg-nird-green rounded-full flex items-center justify-center mt-1 mr-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900 mb-1">Former les utilisateurs</h3>
                            <p class="text-gray-600 text-sm">Sensibiliser aux gestes simples qui réduisent l'impact environnemental.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 rounded-xl p-8">
                <div class="text-center mb-6">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Impact du numérique</h3>
                </div>
                <div class="space-y-4">
...
<!-- Ré-emploi et reconditionnement -->
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Ré-emploi et reconditionnement du matériel</h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Prolonger la durée de vie du matériel informatique pour réduire l'impact environnemental
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-xl p-8 shadow-sm">
                ...
                <p class="text-gray-600 mb-4">
                    Remise à neuf du matériel informatique existant pour une seconde vie performante.
                </p>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Don et réaffectation</h3>
                <p class="text-gray-600 mb-4">
                    Donner une seconde vie au matériel fonctionnel auprès d'associations ou d'autres structures.
                </p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Recyclage responsable</h3>
                <p class="text-gray-600 mb-4">
                    Pour le matériel en fin de vie, assurer un recyclage dans des filières agréées.
                </p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 border border-blue-200">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900">Ateliers participatifs</h3>
                </div>
                <p class="text-gray-700 mb-4">
                    Organisation de sessions collaboratives pour identifier les besoins et co-créer les solutions adaptées à votre contexte.
                </p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
            ...
            <div class="bg-nird-green-light rounded-xl p-8 border border-nird-green">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900">Gouvernance partagée</h3>
                </div>
                <p class="text-gray-700 mb-4">
                    Mise en place de groupes de travail et de processus de décision collectifs pour garantir l'adhésion de tous.
                </p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-8 border border-purple-200">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900">Partage de connaissances</h3>
                </div>
                <p class="text-gray-700 mb-4">
                    Capitalisation des expériences et diffusion des bonnes pratiques au sein de votre réseau.
                </p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-8 border border-yellow-200">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900">Innovation collective</h3>
                </div>
                <p class="text-gray-700 mb-4">
                    Encouragement de la créativité et de l'expérimentation pour trouver des solutions innovantes ensemble.
                </p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
